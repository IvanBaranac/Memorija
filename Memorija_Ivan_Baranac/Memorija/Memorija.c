...
void sacuvaj_u_dat(int redovi, int kolone, char* ime, int broj_poteza, int tezina, char* naziv_datoteka);
void prikaz_poteza_i_cuvanje_poteza(int redovi, int kolone, char* ime, int broj_poteza, int tezina, char* istorija_igranja, char* potezi);
